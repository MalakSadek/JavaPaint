...
public class Ellipse extends Shape {
     ...
     * @param shapeType - the type of the shape described as a string, Ellipse in this case
     */
    public Ellipse(int startX, int startY, int endX, int endY, int strokeWidth, Color fillColor, Color strokeColor, String shapeType) {
