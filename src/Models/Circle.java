...
public class Circle extends Shape {
     ...
     * @param shapeType - the type of the shape described as a string, Circle in this case
     */
    public Circle(int startX, int startY, int endX, int endY, int strokeWidth, Color fillColor, Color strokeColor, String shapeType) {
