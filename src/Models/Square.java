...
public class Square extends Shape {
     ...
     * @param shapeType - the type of the shape described as a string, Square in this case
     */
    public Square(int startX, int startY, int endX, int endY, int strokeWidth, Color fillColor, Color strokeColor, String shapeType) {
