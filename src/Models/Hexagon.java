...
public class Hexagon extends Shape {
     ...
     * @param shapeType - the type of the shape described as a string, Hexagon in this case
     */
    public Hexagon(int startX, int startY, int endX, int endY, int strokeWidth, Color fillColor, Color strokeColor, String shapeType) {
