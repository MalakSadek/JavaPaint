...
public class Parallelogram extends Shape {
     ...
     * @param shapeType - the type of the shape described as a string, Parallelogram in this case
     */
    public Parallelogram(int startX, int startY, int endX, int endY, int strokeWidth, Color fillColor, Color strokeColor, String shapeType) {
