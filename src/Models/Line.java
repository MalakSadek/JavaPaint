...
public class Line extends Shape {
     ...
     * @param shapeType - the type of the shape described as a string, Line in this case
     */
    public Line(int startX, int startY, int endX, int endY, int strokeWidth, Color fillColor, Color strokeColor, String shapeType) {
