...
public class Octagon extends Shape {
     ...
     * @param shapeType - the type of the shape described as a string, Octagon in this case
     */
    public Octagon(int startX, int startY, int endX, int endY, int strokeWidth, Color fillColor, Color strokeColor, String shapeType) {
